    ...
    plus: (input, seatPrice) => {
      ...
      if (input.seats > input.teamSize) {
        recs.push({
          ...
          description:
            "You have more Plus licenses than active team members.",
          monthlySavings:
            (input.seats - input.teamSize) * seatPrice,
        })
      }
    ...
    enterprise: (input, seatPrice) => {
      ...
      if (input.seats > input.teamSize) {
        recs.push({
          ...
          description:
            "Enterprise seats are expensive — unused licenses should be removed immediately.",
          monthlySavings:
            (input.seats - input.teamSize) * seatPrice,
        })
      }
    ...
    pro: (input, seatPrice) => {
      ...
      if (input.seats > input.teamSize) {
        recs.push({
          ...
          description:
            "You have more Pro licenses than active developers.",
          monthlySavings:
            (input.seats - input.teamSize) * seatPrice,
        })
      }
    ...
    business: (input, seatPrice) => {
      ...
      if (input.seats > input.teamSize) {
        recs.push({
          ...
          description:
            "Remove licenses for inactive developers to cut costs.",
          monthlySavings:
            (input.seats - input.teamSize) * seatPrice,
        })
      }
    ...
    individual: (input, seatPrice) => {
      ...
      if (input.seats > input.teamSize) {
        recs.push({
          ...
          description:
            "Remove licenses not tied to active developers.",
          monthlySavings:
            (input.seats - input.teamSize) * seatPrice,
        })
      }
    ...
    business: (input, seatPrice) => {
      ...
      if (input.seats > input.teamSize) {
        recs.push({
          ...
          description:
            "Unused developer seats are a direct cost with no return.",
          monthlySavings:
            (input.seats - input.teamSize) * seatPrice,
        })
      }
    ...
    pro: (input, seatPrice) => {
      ...
      if (input.seats > input.teamSize) {
        recs.push({
          ...
          description:
            "You have more Pro licenses than active team members.",
          monthlySavings:
            (input.seats - input.teamSize) * seatPrice,
        })
      }
    ...
    pro: (input, seatPrice) => {
      ...
      if (input.seats > input.teamSize) {
        recs.push({
          ...
          description:
            "Remove licenses for inactive team members.",
          monthlySavings:
            (input.seats - input.teamSize) * seatPrice,
        })
      }
    ...
    pro: (input, seatPrice) => {
      ...
      if (input.seats > input.teamSize) {
        recs.push({
          ...
          description:
            "Remove licenses for developers who are no longer active.",
          monthlySavings:
            (input.seats - input.teamSize) * seatPrice,
        })
      }
    ...
    teams: (input, seatPrice) => {
      ...
      if (input.seats > input.teamSize) {
        recs.push({
          ...
          description:
            "Unused team seats should be removed to reduce monthly overhead.",
          monthlySavings:
            (input.seats - input.teamSize) * seatPrice,
        })
      }
...
function calculateMonthlySpend(input: AuditInput) {
  ...
  const seatPrice =
    providerPricing[input.plan.toLowerCase()] ?? 0
...
export async function runAudit(
  ...
  const { currentSpend, seatPrice } =
    calculateMonthlySpend(input)

  const toolRules =
    providerRules[input.toolId.toLowerCase()]

  let recommendations: AuditRecommendation[] = []

  if (
    toolRules &&
    toolRules[input.plan.toLowerCase()]
  ) {
    recommendations =
      toolRules[input.plan.toLowerCase()](
        input,
  ...
  if (
    ...
    if (seatPrice >= 20) {
      const mismatchSavings =
        (seatPrice - 20) * input.seats

      recommendations.push({
        title: "Realign Tooling with Primary Use Case",
        description:
          "Your primary use case is writing, but you are paying a premium for Cursor, an IDE. Switching to standard Claude Pro or ChatGPT Plus aligns tooling with actual needs and reduces seat costs.",
